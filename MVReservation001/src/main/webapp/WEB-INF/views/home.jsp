...
<body>
	...
	<main id="main" class="main">
		...
		<section class="section">
			<div class="row">
				<div class="col">
				<h4>대표 영화 사이트 CGV를 모델삼아 기능들을 만들어 보았습니다. </h4></br>
				<h5>영화목록 - CGV에서 영화데이터만 크롤링해와서 제작하였습니다. </h5>
				<h5>극장기능 - 극장을 누르면 해당 극장에서 상영하는 영화가 나옵니다. </h5>
				<h5>예매기능 - 영화, 극장, 날짜, 상영관 및 시간표까지 선택하고 예매 인원수까지 선택하면 예매가능합니다. </h5>
				<h5>그외 - 영화 관람평작성, 관람평보기, 보기예매취소 등등  </h5>
				</div>
			</div>
		</section>
